...
function SignUpContent() {
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If user session was immediately created (e.g. email confirmations disabled in dev)
      if (data.session) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#f5f5f5] flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-white/20 selection:text-white py-12">
      ...
      <div className="absolute bottom-10 left-10 w-[300px] h-[300px] bg-emerald-500/[0.03] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="mt-8 flex items-center gap-2 text-xs text-white/40">
        ...
        <span>End-to-end encrypted session and secure identity storage</span>
      </div>
    </div>
  );
}
